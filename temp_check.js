...
const WEAPONS = {
    ...
    chakram: { key: 'chakram', name: '环刃', icon: '⭕', dmg: 16, cd: 0.6, speed: 320, pierce: 4, type: 'proj', color: '#f80', maxLevel: 8 },
...
const SUPER_WEAPONS = {
    ...
    buzzsaw: { name: '电锯', icon: '🪚', dmg: 20, cd: 0.2, speed: 400, pierce: 10, type: 'proj', color: '#f80' },

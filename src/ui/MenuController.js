class MenuController {
    constructor(options = {}) {
        ...
        this.onOpenInheritance = options.onOpenInheritance || (() => {});
        ...
        this.menuInheritance = document.getElementById('menuInheritance');
    ...
    init() {
        ...
        if (this.menuInheritance) {
            this.menuInheritance.onclick = () => this.onOpenInheritance();
        }
    ...
    initBackgroundAnimation() {
        ...
        const bgSrc = window.RuntimeAssetBase?.resolveSprite?.('ui/ChatGPT Image.png?v=menu_static2') || 'assets/runtime/sprites/ui/ChatGPT Image.png?v=menu_static2';
        const img = new Image();
        img.src = bgSrc;

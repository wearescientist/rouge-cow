class MenuOverlayController {
    ...
    init() {
        ...
        style.textContent = `
            ...
            .menu-overlay-card { width: min(560px, calc(100vw - 32px)); padding: 28px 26px 22px; border: 1px solid rgba(255,255,255,0.14); border-radius: 18px; background: linear-gradient(180deg, rgba(10,14,24,0.96), rgba(8,11,19,0.98)); box-shadow: 0 18px 50px rgba(0,0,0,0.42); color: #f4f2ef; }
            .menu-overlay-title { margin: 0 0 14px; font-size: 36px; line-height: 1.1; }
            .menu-overlay-message { margin: 0; font-size: 20px; line-height: 1.7; color: #d4dae7; }
            .menu-overlay-actions { display: flex; gap: 14px; justify-content: flex-end; margin-top: 24px; }
            .menu-overlay-btn { min-width: 150px; padding: 14px 20px; border: 1px solid rgba(255,255,255,0.14); border-radius: 12px; background: rgba(255,255,255,0.06); color: #fff; font: inherit; font-size: 18px; cursor: pointer; }

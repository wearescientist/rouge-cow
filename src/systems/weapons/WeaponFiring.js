...
(function(global) {
    ...
    Weapon.prototype.applyProjectileVisualConfig = function(b) {
        ...
        } else if ((b.weaponKey === 'cross' || b.weaponKey === 'heaven_sword') && (subtype === 'bounce' || subtype === 'cross_split_homing')) {
            cfg.sprite = b.weaponKey === 'heaven_sword' ? 'weapon_heaven_sword' : 'weapon_cross';
    ...
    Weapon.prototype.fireArea = function(player, target, dmg, stats) {
        ...
        for (let i = 0; i < count; i++) {
            ...
            bullets.push(this.applyCombatStats({
                ...
                bottleFlight: isLaBorra ? 0.32 : 0.26,
                bottleSize: isLaBorra ? 26 : 18,
                growFrom: this.cfg.growFrom || poolRadius,
                growTo: this.cfg.growTo || poolRadius,
                growthDelay: this.cfg.growthDelay || 0.75,

...
const WEAPONS = {
    whip: { key: 'whip', name: '圣剑', icon: '⚔️', iconSprite: 'weapon_whip', dmg: 13, cd: 1.1, range: 200, orbitRadius: 200, type: 'orbit', color: '#ffd36b', knockback: 30, count: 1, duration: 24, rotationSpeed: 2.618, orbitalDrawSize: 56.65, orbitHitPadding: 200, orbitVisualSpinSpeed: 0, maxLevel: 8 },
    scythe: { key: 'scythe', name: '镰刀', icon: '⚰️', iconSprite: 'weapon_scythe', dmg: 36, cd: 0.82, range: 200, arcAngle: 90, type: 'melee', subtype: 'circle', color: '#884488', knockback: 42, outerRingBonus: 0.26, maxLevel: 8 },
    wand: { key: 'wand', name: '魔杖', icon: '🔮', dmg: 15, cd: 0.92, speed: 540, range: 490, type: 'proj', subtype: 'homing', color: '#5b8cff', homingStrength: 1.05, homingDelay: 0.08, homingRange: 460, scatterAngle: 0.88, projectileLife: 1.8, count: 3, maxLevel: 8 },
    knife: { key: 'knife', name: '飞刀', icon: '🗡️', dmg: 46, attackCoeff: 2.18, cd: 0.29, speed: 900, range: 580, type: 'proj', subtype: 'guardian_knife', color: '#ff5252', count: 1, searchRadius: 760, returnSpeed: 1180, idleRadius: 42, passThroughDistance: 126, curveRadius: 110, hitCooldown: 0.27, maxLevel: 8 },
    axe: { key: 'axe', name: '雷神战斧', icon: '🪓', dmg: 18, cd: 0.29, speed: 580, range: 430, type: 'proj', subtype: 'boomerang', color: '#8b4513', count: 1, returnSpeed: 1020, hoverDuration: 0.08, impactLightning: true, impactRadius: 88, impactShockwaveRadius: 132, impactCenterDamageScale: 0.92, impactShockwaveDamageScale: 0.64, impactLightningChain: 3, impactLightningRange: 320, impactLightningDmgScale: 0.64, impactLightningAuraRange: 180, impactLightningAuraTick: 0.16, impactLightningAuraDmgScale: 0.18, impactStorm: false, impactStormDelay: 0.18, impactStormDamageScale: 0.42, impactField: false, impactFieldRadius: 104, impactFieldDuration: 1.0, impactFieldTick: 0.22, maxLevel: 8 },
    cross: { key: 'cross', name: '十字架', icon: '✝️', dmg: 40, cd: 0.78, speed: 560, range: 580, type: 'proj', subtype: 'cross_split_homing', color: '#e8e8e8', count: 1, pierce: 1, splitCount: 2, splitTimes: 1, splitRadius: 260, splitDamageScale: 1.04, splitHoming: true, splitHomingStrength: 1.24, splitHomingRange: 340, splitChildLife: 1.9, splitChildSpeed: 580, maxLevel: 8 },
    fireball: { key: 'fireball', name: '双头龙吐息', icon: '🐉', dmg: 14, cd: 0.84, speed: 560, range: 380, type: 'proj', subtype: 'dragon_breath', color: '#ff7a40', count: 1, projectileLife: 0.92, explodeRadius: 88, staggerDelay: 0.06, burnFieldDuration: 1.2, burnFieldRange: 68, burnFieldDmg: 5, burnFieldTick: 0.24, slow: 0.22, slowDuration: 0.9, pierce: 2, freezeMeterGain: 0.34, freezeDuration: 1.0, elementBurst: false, elementBurstRadius: 64, maxLevel: 8 },
    shuriken: { key: 'shuriken', name: '手里剑', icon: '🎯', dmg: 19, cd: 0.55, speed: 660, range: 440, type: 'proj', subtype: 'fan', color: '#9aa0a6', count: 3, spread: 28, supplementaryWaves: [{ delay: 0.09, count: 2, spread: 16, damageScale: 0.85 }], maxLevel: 8 },
    ...
    laser: { key: 'laser', name: '激光', icon: '🔦', dmg: 16, cd: 0.78, range: 3000, type: 'laser', color: '#ff0044', width: 14, beamLife: 0.18, tickCooldown: 0.16, maxLevel: 8 },
    poison_dart: { key: 'poison_dart', name: '毒镖', icon: '📍', dmg: 34, cd: 0.38, speed: 760, range: 540, type: 'proj', subtype: 'poison_dart', color: '#49b85b', poisonStacksOnHit: 1, poisonMaxStacks: 7, poisonStackDmg: 12, poisonDuration: 5.2, poisonSpreadTargets: 2, poisonSpreadRange: 280, poisonSpreadMaxGen: 1, poisonCloudOnDeath: false, count: 1, maxLevel: 8 },
    bible: { key: 'bible', name: '武装法典', icon: '📖', dmg: 36, cd: 3.4, range: 212, count: 2, duration: 12.5, orbitRadius: 212, orbitSpeed: 1.76, orbitalDrawSize: 60, orbitHitPadding: 52, orbitVisualSpinSpeed: 2.1, type: 'orbit', color: '#ffd700', codexWeaponized: true, codexShotInterval: 0.62, codexShotDmgScale: 1.56, codexExtraShots: 3, codexBurstChance: 0.22, codexVolleyBudget: 6, codexTargetRange: 3200, codexArsenal: ['wand','knife','shuriken','laser','cross','fireball'], maxLevel: 8 },
    ...
    holy_water: { key: 'holy_water', name: '圣水', icon: '💧', dmg: 13, cd: 1.12, range: 560, duration: 3.9, tickRate: 0.17, slow: 0.18, type: 'area', color: '#00bfff', count: 1, growFrom: 84, growTo: 188, growthDelay: 0.64, maxBurstDmgScale: 0, exposeMultiplier: 0, exposeDuration: 0, maxLevel: 8 },
    radiance: { key: 'radiance', name: '辉耀', icon: '🔥', dmg: 9, cd: 0.23, range: 332, tickRate: 0.18, type: 'aura', color: '#ff6600', burn: true, maxLevel: 8 }
};
...
const WEAPON_EVOLUTIONS = {
    whip: { requires: 'hollow_heart', result: 'blood_whip', name: '圣裁月轮', icon: '🗡️', desc: '环绕圣剑化作御剑月轮，范围与伤害大幅提升', bonus: { dmg: 1.5, lifeSteal: 0.1, crit: 0.15, range: 2.0, count: 4, rotationSpeed: 1.18, orbitalDrawSize: 1.18, orbitHitPadding: 1.2 } },
    ...
    cross: { requires: 'clover', result: 'heaven_sword', name: '审判圣印', icon: '✝️', desc: '分裂数和分裂次数提升，圣印爆点范围增大', bonus: { dmg: 1.7, splitCount: 4, splitTimes: 2, splitRadius: 340, splitDamageScale: 1.02 } },
    ...
    holy_water: { requires: 'alchemist_flask', result: 'la_borra', name: '圣泉扩散', icon: '💦', desc: '蔓延更快更广，区域内敌人易伤', bonus: { dmg: 1.35, count: 1, growFrom: 95, growTo: 235, growthDelay: 0.58, maxBurstDmgScale: 1.2, exposeMultiplier: 1.18, exposeDuration: 1.1 } },
    ...
    scythe: { requires: 'armor', result: 'death_scythe', name: '终焉收割', icon: '💀', desc: '整圈收割，外圈高额伤害', bonus: { dmg: 1.8, range: 2.0, arcAngle: 360, outerRingBonus: 0.95 } },
...
const SUPER_WEAPONS = {
    blood_whip: { name: '圣裁月轮', icon: '🗡️', dmg: 72, cd: 0.6, range: 360, orbitRadius: 360, type: 'orbit', color: '#ffe08a', knockback: 84, lifeSteal: 0.2, count: 4, crit: 0.28, critDmg: 2.4, duration: 24, rotationSpeed: 3.491, orbitalDrawSize: 74.69, orbitHitPadding: 360, orbitVisualSpinSpeed: 0, special: '御剑月轮环绕切割，范围翻倍' },
    death_scythe: { name: '终焉收割', icon: '💀', iconSprite: 'weapon_death_scythe', dmg: 222, cd: 0.46, range: 400, arcAngle: 360, type: 'melee', subtype: 'circle', color: '#440044', knockback: 96, count: 1, outerRingBonus: 1.78, special: '整圈收割，外圈高伤' },
    holy_wand: { 
        name: '圣魔星雨', icon: '🔯', dmg: 44, cd: 0.46, speed: 600, range: 500,
        type: 'proj', subtype: 'homing', color: '#9ab6ff', homingStrength: 2.9,
        homingDelay: 0.05, homingRange: 520, scatterAngle: 0.72, projectileLife: 1.22,
        count: 6, pierce: 2, special: '高频星弹群+短寿命强追踪'
    },
    thousand_blade: { 
        name: '御刃', icon: '💠', dmg: 138, cd: 0.11, speed: 1280, range: 820,
        type: 'proj', subtype: 'guardian_knife', color: '#ff7a5c',
        count: 5, searchRadius: 1320, returnSpeed: 1800, idleRadius: 50, passThroughDistance: 172, curveRadius: 118, hitCooldown: 0.11, special: '五刃永久追猎穿刺'
    },
    death_spiral: { name: '诸神黄昏战斧', icon: '🌀', dmg: 154, cd: 0.135, speed: 700, range: 620, type: 'proj', subtype: 'boomerang', color: '#880000', count: 1, returnSpeed: 1320, hoverDuration: 0.06, impactLightning: true, impactRadius: 156, impactShockwaveRadius: 244, impactCenterDamageScale: 1.82, impactShockwaveDamageScale: 1.22, impactLightningChain: 18, impactLightningRange: 820, impactLightningDmgScale: 1.66, impactLightningAuraRange: 310, impactLightningAuraTick: 0.12, impactLightningAuraDmgScale: 0.46, impactStorm: true, impactStormDelay: 0.12, impactStormDamageScale: 1.46, impactField: true, impactFieldRadius: 216, impactFieldDuration: 3.0, impactFieldTick: 0.16, special: '单把神斧往返，落点雷暴+雷区' },
    heaven_sword: { name: '审判圣印', icon: '✝️', iconSprite: 'weapon_heaven_sword', dmg: 154, cd: 0.4, speed: 800, range: 860, type: 'proj', subtype: 'cross_split_homing', color: '#fff1a6', count: 2, pierce: 2, splitCount: 5, splitTimes: 2, splitRadius: 440, splitDamageScale: 1.34, splitHoming: true, splitHomingStrength: 1.94, splitHomingRange: 560, splitChildLife: 2.5, splitChildSpeed: 840, returnNova: true, returnNovaRadius: 160, special: '分裂追踪圣印' },
    hellfire: { name: '极寒烈焰', icon: '🔥', dmg: 182, cd: 0.4, speed: 840, range: 660, type: 'proj', subtype: 'explode', color: '#74dbff', count: 1, projectileLife: 1.3, explodeRadius: 196, burnFieldDuration: 3.1, burnFieldRange: 176, burnFieldDmg: 27, burnFieldTick: 0.11, slow: 0.48, slowDuration: 1.38, freezeMeterGain: 1.06, freezeDuration: 1.76, elementBurst: true, elementBurstRadius: 140, special: '融合蓝焰弹：大范围爆炸、燃烧与冻结积累' },
    ninja_storm: { 
        name: '忍具齐射', icon: '🌀', dmg: 76, cd: 0.28, speed: 760, range: 620,
        type: 'proj', subtype: 'fan', color: '#aab0b8', count: 5, spread: 40,
    ...
    prism_beam: { 
        name: '炽天使硫磺', icon: '🔴', dmg: 84, cd: 0.86, range: 3000,
        type: 'laser', color: '#ff2f6d', width: 36, beamLife: 0.72, tickCooldown: 0.05,
        homingCurve: true, turnRate: 2.8, maxTrackAngle: 0.62, segmentLength: 52, lockTrackToFireAngle: true, uniqueBeam: true,
        special: '单条重型圣焰束，沿发射方向锥体内曲线索敌贯穿'
    },
    toxic_strike: { 
        name: '瘟疫花绽', icon: '☠️', dmg: 112, cd: 0.15, speed: 840, range: 860,
        type: 'proj', subtype: 'poison_dart', color: '#1bb25a',
        count: 1, poisonStacksOnHit: 3, poisonMaxStacks: 10, poisonStackDmg: 16, poisonDuration: 5.4,
        poisonSpreadTargets: 4, poisonSpreadRange: 320, poisonSpreadMaxGen: 2, poisonCloudOnDeath: true, poisonCloudDuration: 2.4, poisonCloudStacks: 2,
        special: '高层叠毒+稳定裂变'
    },
    unholy_vespers: { name: '终末武装法典', icon: '📿', dmg: 126, cd: 0.6, range: 236, type: 'orbit', color: '#ff6600', count: 7, duration: 26, rotationSpeed: 2.0, orbitalDrawSize: 76, orbitHitPadding: 68, codexWeaponized: true, codexShotInterval: 0.34, codexShotDmgScale: 1.62, codexExtraShots: 5, codexBurstChance: 0.48, codexVolleyBudget: 8, codexTargetRange: 4200, codexArsenal: ['wand','knife','shuriken','laser','cross','fireball'], special: '环绕书随机齐射' },
    la_borra: { name: '圣泉扩散', icon: '💦', dmg: 154, cd: 0.48, range: 1140, duration: 8.6, type: 'area', color: '#4488ff', count: 1, tickRate: 0.065, slow: 0.32, growFrom: 124, growTo: 320, growthDelay: 0.32, maxBurstDmgScale: 2.14, exposeMultiplier: 2.0, exposeDuration: 2.2, special: '大范围蔓延圣池+易伤' },
    solar_radiance: { name: '日轮真焰', icon: '☀️', dmg: 118, cd: 0.075, range: 416, tickRate: 0.105, type: 'aura', color: '#ffaa00', burn: true, blind: false, burnSpread: true, special: '范围不降，强化灼烧联动' },
...
if (typeof window !== 'undefined') {
    ...
    window.SUPER_WEAPONS = SUPER_WEAPONS;

...
class AudioController {
    constructor(game) {
        ...
        this.registry = {
            // ===== 武器类 (WEAPON) - 直接映射 =====
            // 武器音效 - 统一较低音量 (v0.28: 稍微调大一点)
            'whip':     { type: 'file', file: 'weapons/whip_crack_Sharp_lea_#3-1772638713348.mp3', vol: 0.24 },
            'scythe':   { type: 'file', file: 'weapons/Heavy_scythe_slash_#2-1772638772954.mp3', vol: 0.24 },
            'knife':    { type: 'file', file: 'weapons/knife_throw_v1.mp3', vol: 0.26 },
            'axe':      { type: 'file', file: 'weapons/axe_throw_v1.mp3', vol: 0.24 },
            'cross':    { type: 'file', file: 'weapons/cross_launch_v1.mp3', vol: 0.24 },
            'wand':     { type: 'file', file: 'weapons/wand_cast_v1.mp3', vol: 0.26 },
            'fireball': { type: 'file', file: 'weapons/fireball_v1.mp3', vol: 0.22 },
            'shuriken': { type: 'file', file: 'weapons/shuriken_v2.mp3', vol: 0.26 },
            'icicle':   { type: 'file', file: 'weapons/icicle_v2.mp3', vol: 0.26 },
            'lightning':{ type: 'file', file: 'weapons/lighting.ogg', vol: 0.24 },
            'laser':    { type: 'file', file: 'weapons/laser2.ogg', vol: 0.24 },
            'dart':     { type: 'file', file: 'weapons/dart_shoot_v2.mp3', vol: 0.26 },
            'poison_dart':{ type: 'file', file: 'weapons/dart_shoot_v2.mp3', vol: 0.26 },
            'holy_water':{ type: 'file', file: 'weapons/bottle_broken_.mp3', vol: 0.24 },
            ...
            'bossEnter': { type: 'file', file: 'boss enter.ogg', vol: 0.6 },
            ...
            // ===== 其他音效 =====
            'warning':   { type: 'file', file: 'hit/impactMetal_heavy_002.ogg', vol: 0.7 },
            'wave':      { type: 'file', file: 'ui/switch_001.ogg', vol: 0.6 },
            'elite':     { type: 'file', file: 'hit/impactMetal_heavy_002.ogg', vol: 0.7 },
            ...
            // 兼容旧调用
            'crit':      { type: 'hit', material: 'shell', count: 3, heavyOnly: true, vol: 0.8 }, // 暴击
            'hit':       { type: 'hit', material: 'flesh', count: 5, heavyCount: 3, vol: 0.7 },   // 默认命中

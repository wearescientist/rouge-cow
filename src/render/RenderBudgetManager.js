    ...
    const manager = {
        ...
        getBudget(game, room = null, canvasOrWidth = null, height = null) {
            ...
            const budget = {
                ...
                blurProfile: tier === 'low'
                    ? { tier: 'low', bloomEvery: hidden ? 2 : 3, colorEvery: 2, lightBudgetScale: hidden ? 0.72 : 0.55, bloomAlphaScale: 0.72, colorAlphaScale: 0.78 }
                    : (tier === 'medium'
                        ? { tier: 'medium', bloomEvery: 2, colorEvery: 1, lightBudgetScale: hidden ? 0.82 : 0.72, bloomAlphaScale: 0.86, colorAlphaScale: 0.9 }
                        : { tier: 'full', bloomEvery: 1, colorEvery: 1, lightBudgetScale: 1, bloomAlphaScale: 1, colorAlphaScale: 1 })
            };

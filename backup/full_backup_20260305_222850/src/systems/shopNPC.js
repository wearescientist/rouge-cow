...
class ShopNPCSystem {
    ...
    showNPCBubbleWithTyping(text) {
        ...
        `;
        bubble.innerHTML = `
            <div style="color: ${emotionColor}; font-size: 11px; margin-bottom: 6px; text-transform: uppercase; letter-spacing: 1px; font-weight: bold;">盲眼</div>
            <div class="dialogue-text"></div>
            <div style="position: absolute; right: -10px; top: 50%; transform: translateY(-50%); width: 0; height: 0; border-top: 10px solid transparent; border-bottom: 10px solid transparent; border-left: 10px solid ${emotionColor};"></div>
        `;
    ...
    showPlayerBubbleWithTyping(text) {
        ...
        `;
        bubble.innerHTML = `
            <div style="color: #4f4; font-size: 11px; margin-bottom: 6px; text-transform: uppercase; letter-spacing: 1px;">牛牛</div>
            <div class="dialogue-text"></div>
            <div style="position: absolute; left: -8px; top: 50%; transform: translateY(-50%); width: 0; height: 0; border-top: 8px solid transparent; border-bottom: 8px solid transparent; border-right: 8px solid #4f4;"></div>
        `;

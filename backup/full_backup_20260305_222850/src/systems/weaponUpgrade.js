...
const WEAPON_UPGRADE_TABLE = {
    ...
    laser: {
        name: '激光',
        upgrades: [
            { level: 2, dmg: 1.3, width: 14, cd: 0.65, desc: '伤害+30%，宽度+2，CD-7%' },
            { level: 3, dmg: 1.5, width: 16, desc: '伤害+50%，宽度+2' },
            { level: 4, count: 2, dmg: 1.3, desc: '双重激光+伤害+30%（质变）' },
            { level: 5, dmg: 1.4, width: 18, cd: 0.6, desc: '伤害+40%，宽度+2' },
            { level: 6, dmg: 1.5, cd: 0.5, desc: '伤害+50%，CD-17%' },
            { level: 7, count: 3, dmg: 1.2, desc: '三重激光' },
            { level: 8, dmg: 2.0, width: 22, desc: '伤害+100%，超宽激光（完全体）' }
        ]
    },
    poison_dart: {
        name: '毒镖',

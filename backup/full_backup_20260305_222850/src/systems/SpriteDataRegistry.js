...
class SpriteDataRegistry {
    ...
    _setupDefaults() {
        ...
        const defaults = {
            ...
            'mouse': { canvasWidth: 64, canvasHeight: 64, modelOffsetX: 20, modelOffsetY: 22, modelWidth: 24, modelHeight: 20, anchor: { center: { x: 32, y: 32 }, feet: { x: 32, y: 42 } }, hitboxRatio: { w: 0.75, h: 0.9 }, shadowOffsetY: 2 },
            // 小型 (size 22-28)
